...
[![Where Do We Go From Here film poster]({{ site.baseurl }}/assets/images/movieposterthumbnail_orig.jpg){:style="max-width:600px;float:right;margin-left:1em;"}](https://youtu.be/CEnifgJkHVk)
...
Watch on: [Facebook](https://www.facebook.com/SOMLKDay/){:target="_blank"} or [YouTube](https://youtu.be/CEnifgJkHVk){:target="_blank"}
...
{% include video.html id="VbmlMarDaDk" provider="youtube" %}
*The documentary video that premiered January 18, 2021*

{% include video.html id="4FXDgbVIXlA" provider="youtube" %}
*The live panel discussion that followed the premiere*

{% include video.html id="501990265" provider="vimeo" %}
*In Memoriam of those we lost, nationally and locally, in 2020*
